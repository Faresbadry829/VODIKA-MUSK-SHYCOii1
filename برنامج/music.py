...
@ العميل . on_message ( الأمر ([ "mplay" ، f "mplay @ { BOT_USERNAME } " ، "شغل" ، "ماجي" ، "عمر" ، "اوشا" ، "فودا" ، "حسن" ، "مستفز" ، "فارس" ، "جوست" ، "دربكه" ، "روما" ، "شيكو" ، "خالد" ، "رحمه" ، "بالي" ،، "فوديكا" ، "" ، "play" ]) &  other_filters )
